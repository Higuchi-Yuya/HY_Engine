...
void GameScene::SetLightGroup(LightGroup* lightGroup)
{
	gameLight_->SetLightGroup(lightGroup);
}

void GameScene::SetPointInfo(std::vector<WorldTransform*> pointLightsInfo)
{
	gameLight_->SetPointInfo(pointLightsInfo);
}
